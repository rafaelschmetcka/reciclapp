...
import 'historico_coletor_model.dart';
export 'historico_coletor_model.dart';
...
class _HistoricoColetorWidgetState extends State<HistoricoColetorWidget> {
  late HistoricoColetorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoricoColetorModel());
